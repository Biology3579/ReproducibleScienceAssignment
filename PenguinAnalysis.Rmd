...
In this assignemtns I will be ....

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

you can access all the packages (and correct version by running the ...) this will show you a version fo all the apockesg and packegs mverisont aht were used wo all the code can be run appropiately and it all works.

```{r packages, ...}
knitr::opts_chunk$set(echo = TRUE)

#loading packages
library(tidyverse) # for data vis 
