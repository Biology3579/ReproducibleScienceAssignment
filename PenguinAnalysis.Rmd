...
anova_morphology <- aov(bill_morphology ~ species, data = analysis_data)
summary(anova_morphology)
```

```{r bill-morphology-Tukey-Kramer}
# Tukey-Kramer test for pairwise comparisons of bill morphology between penguin species
tukey_results_morphology <- TukeyHSD(aov(bill_morphology ~ species, data = analysis_data))
print(tukey_results_morphology)
```
...
anova_length <- aov(bill_length_mm ~ species, data = analysis_data)
...
tukey_results_length <- TukeyHSD(aov(bill_length_mm ~ species, data = analysis_data))
...
anova_depth <- aov(bill_depth_mm ~ species, data = analysis_data)
summary(anova_depth)
```

```{r bill-depth-Tukey-Kramer}
# Tukey-Kramer test for pairwise comparisons of bill depth between penguin species
tukey_results_depth <- TukeyHSD(aov(bill_depth_mm ~ species, data = analysis_data))
